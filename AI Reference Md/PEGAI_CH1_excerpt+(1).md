...
This excerpt contains Chapter 1. The complete book is
...
This is already a remarkable response for a naive prompt, which feels like magic
...
for you.
2 | Chapter 1: The Five Principles of Prompting

Addressing these problems is the basis for the core principles we use throughout
...
The Five Principles of Prompting | 3

used in the prompt and the response, so prompt engineers need to make these tokens
...
4 | Chapter 1: The Five Principles of Prompting
...
Overview of the Five Principles of Prompting | 5
...
changes.
6 | Chapter 1: The Five Principles of Prompting
...
Overview of the Five Principles of Prompting | 7
...
8 | Chapter 1: The Five Principles of Prompting

By the way, a human would also struggle to complete this task without a good brief,
...
fit any foot size:
10 | Chapter 1: The Five Principles of Prompting
...
There are other myriad ways of providing direction. In the image generation exam‐
...
12 | Chapter 1: The Five Principles of Prompting
...
14 | Chapter 1: The Five Principles of Prompting
...
16 | Chapter 1: The Five Principles of Prompting
...
There’s a trade-off between reliability and creativity: go past three to five examples
...
18 | Chapter 1: The Five Principles of Prompting
...
20 | Chapter 1: The Five Principles of Prompting
...
Alternatively, if you’ d prefer not to preset an API key, then you can manually set the
...
def get_response(prompt):
    response = client.chat.completions.create(
        model="gpt-3.5-turbo",
22 | Chapter 1: The Five Principles of Prompting
...
24 | Chapter 1: The Five Principles of Prompting

8. This dataframe is then saved to a CSV file with the Pandas built-in to_csv8.
...
26 | Chapter 1: The Five Principles of Prompting
...
7. The function update_response() fetches the next response from the dataframe,7.
...
28 | Chapter 1: The Five Principles of Prompting
...
Once you start rating which examples were good, you can more easily update the
...
30 | Chapter 1: The Five Principles of Prompting
...
32 | Chapter 1: The Five Principles of Prompting

One of the core principles of engineering is to use task decomposition to break prob‐
...
finished. However, when it has all the tokens from a previous response to review, it
...
34 | Chapter 1: The Five Principles of Prompting
...
36 | Chapter 1: The Five Principles of Prompting
...
time of writing. This practice of self-reasoning agents is still early and prone to errors,
...
38 | Chapter 1: The Five Principles of Prompting

In the next chapter, you will be introduced to text generation models. Y ou will learn
